<?php /* Smarty version 2.6.12, created on 2016-01-05 12:21:22
...
commom/img/banner-fale-conosco.jpg" alt="fale conosco" title="fale conosco">
            <h2 class="titulo-interna">Página não encontrada</h2>
        </div>
        <?php $_smarty_tpl_vars = $this->_tpl_vars;
        ...
        <section class="conteudo">
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-md-8">
                    <h1 class="titulo-destaque-pag align-left">Página não encontrada</h1><br>
                </div>  
