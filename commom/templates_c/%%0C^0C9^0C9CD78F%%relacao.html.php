<?php /* Smarty version 2.6.12, created on 2015-10-08 15:06:40
         compiled from admin/calha/relacao.html */ ?>
        ...
        <td>
            <table class="tabela-mostra-dados" cellspacing="2" cellpadding="5" border="0">
                ...
                <tr style="background-color:#D5DDE3" height="20">
                    <td class="texto-consulta"><strong>Código</strong></td>
                    <td class="texto-consulta"><strong>Marca</strong></td>
...
?>
                <tr>
                    <td class="texto-consulta"><?php echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['codigo']; ?>
</td>
                    <td class="texto-consulta"><?php echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['nmMarca']; ?>
</td>
                    <td class="texto-consulta" nowrap="nowrap">< <a href="?acao=visualizar&id=<?php echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['id']; ?>
